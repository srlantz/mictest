                        ...
                        TrackState& result)
{
  ...
  SVector6 residual = SVector6(measurementState.pos[0]-propagatedState.parameters[0],
                               measurementState.pos[1]-propagatedState.parameters[1],
                               measurementState.pos[2]-propagatedState.parameters[2],0,0,0);
